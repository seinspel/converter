...
function assemble(phons, settings) {
  ...
  return phons$1.reduce((function (state, symbol, i) {
                ...
                var stress = withStress && hasPrimary;
                var match;
                ...
                var newLetters = convertSymbol(match[0], behind, ahead1, stress, settings.withMerger, reduplicate, settings.lexicalSets, settings.consonants);
