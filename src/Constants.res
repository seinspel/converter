...
let lexicalSets: ref<option<lexicalSetsType>> = ref(None)
let consonants: ref<option<consonantsType>> = ref(None)

let setSpelling = (lexicalSets_, consonants_) => {
  lexicalSets := Some(lexicalSets_)
  consonants := Some(consonants_)
}
